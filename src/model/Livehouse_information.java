...
=======
    private Date createDate;  // java.util.Date に変更
    private Date updateDate;  // java.util.Date に変更
    ...
    public String getOwner_name() {
        return owner_name;  // 修正されたフィールド名
    }

    public void setOwner_name(String owner_name) {
        this.owner_name = owner_name;  // 修正されたフィールド名
    }
